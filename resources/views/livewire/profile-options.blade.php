<div class="relative" x-data="{ open: false }">
    @if ($user)
        <i class="fa-solid fa-ellipsis-vertical text-color-4" x-on:click="open = !open" x-on:click.outside="open = false"></i>
        ...
        <div class="w-32 max-h-0 shadow-lg bg-color-1 flex flex-wrap absolute right-4 top-0 z-10 transition-all overflow-hidden"
            ...
            @else
                ...
                <button class="w-full py-4 text-color-7 cursor-pointer transition hover:bg-color-5"
                    wire:click="settings">
